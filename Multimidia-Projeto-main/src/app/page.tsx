      ...
      <div className="w-[35%] h-[100vh] ml-[10%]" >
        {
          videos.map((video: Video, index) => {
            return (
              <div className="border border-black mb-3" id="next-video" key={index}>
                <button className="w-full" onClick={() => configVideo(index)}>
                  <img src={video.imageURL} alt="" className="w-full h[200px] mb-1" />
